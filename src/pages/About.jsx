function About() {
  return (
    <section className="p-20">
      <h2 className="text-6xl font-extrabold mb-12 text-center font-poppins">About Me</h2>
      <div className="border-2 border-gray-800 backdrop-blur-sm p-10 rounded-3xl max-w-full bg-white/10">
        <p className="text-2xl text-gray-700 dark:text-gray-300 font-inter opacity-100 z-10">
        ...
        <p className="text-2xl text-gray-700 dark:text-gray-300 font-inter mt-6">
        ...
        <p className="text-2xl text-gray-700 dark:text-gray-300 font-inter my-10">
        ...
        <p className="text-2xl text-gray-700 dark:text-gray-300 font-inter">
